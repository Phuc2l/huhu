...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Toka Hub BF On Top') then
        makefolder('Toka Hub BF On Top')
    end
    if not _G.Dis and not isfile('Toka Hub BF On Top/'..Name..'.json') then
        writefile('Toka Hub BF On Top/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Toka Hub BF On Top') and isfile('Toka Hub BF On Top/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Toka Hub BF On Top/'..Name..'.json'))
...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Toka Is og", 
        Text = tostring(value),
        Icon = "http://www.roblox.com/asset/?id=11668017664",
        Duration = 10
    })
end
function Com()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Toka Notification", 
        Text = "✅  Complete",
        Icon = "http://www.roblox.com/asset/?id=11668017664",
        Duration = 5
    })
...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		ToggleImgUi.Image = "rbxassetid://11668017664"
	...
	ImageLabelfps.Image = "rbxassetid://11668017664"
	...
	ImageLabeltime.Image = "rbxassetid://11668017664"
...
local win = library:Window("Toka",[[Hub]],[[Version : 1.0 ]],"11668017664",Enum.KeyCode.RightControl)
